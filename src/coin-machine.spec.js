...
describe("Coin Machine Tests", () => {
    ...
    test("it will handle 2 different coins from a decorated format", () => {
        expect(coinMachine('£0.03'))
            .toEqual("1x2p 1x1p");
    });
    test("it will handle all the different coins from a decorated format", () => {
        expect(coinMachine('£3.23'))
            .toEqual("1x£2 1x£1 1x20p 1x2p 1x1p");
    });
